(function (e, t) {
  ...
  n.isValidCSSClassChar = function(e) {
    return (
      n.isAlpha(e) || n.isNumeric(e) || e === "-" || e === "_" || e === ":"
    );
  }
  n.isValidCSSIDChar = function(e) {
    return (
      n.isAlpha(e) || n.isNumeric(e) || e === "-" || e === "_" || e === ":"
    );
  }
  ...
  n.isIdentifierChar = function(e, t) {
    return e === "_" || e === "$";
  }
  n.isReservedChar = function(e) {
    return e === "`" || e === "^";
  }
  n.isValidSingleQuoteStringStart = function(e) {
    if (e.length > 0) {
      var t = e[e.length - 1];
      if (
        t.type === "IDENTIFIER" ||
  ...
  class a {
    constructor(e) {
      ...
      this.COMMANDS = {};
      this.FEATURES = {};
      this.LEAF_EXPRESSIONS = [];
      this.INDIRECT_EXPRESSIONS = [];
      this.runtime = e;
  ...
  a.createParserContext = function(e) {
  ...
  a.raiseParseError = function(e, t) {
    t =
  ...
  class o {
    constructor(e, t) {
      ...
      this.HALT = o.HALT;
      this._scriptAttrs = null;
      this.hyperscriptFeaturesMap = new WeakMap();
      this.internalDataMap = new WeakMap();
      this.hyperscriptUrl = e && e.document ? document.currentScript.src : null;
    }
    matchesSelector(e, t) {
      var r =
        e.matches ||
    ...
    t.addFeature("on", function (e, t, r) {
      ...
      do {
        ...
        if (r.matchToken("debounced")) {
          r.requireToken("at");
          var g = e.requireElement("expression", r);
          var b = g.evaluate({});
      ...
      if (r.matchToken("catch")) {
        C = r.requireTokenType("IDENTIFIER").value;
