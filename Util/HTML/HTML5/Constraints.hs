...
type instance LegalChild Nav Ul = Legal
type instance LegalChild Nav Div = Legal
...
type instance LegalChild Div P = Legal
...
type instance LegalChild P String = Legal
